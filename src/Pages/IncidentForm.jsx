            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <div className="mb-10 md:mb-16">
                    ...
                    <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
                        ...
                        all reports are not anonymous and tied to your reporter account for safety and accountablity.
                    </p>
                </div>
                {/* text - end */}
                {/* form - start */}
                <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" id="crimeType" placeholder="e.g. theft, assault, vandalism" className="lowercase w-96 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    ...
                    <div>
                        <label htmlFor="county" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">County Crime was Commited</label>
