            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" id="crimeType" name="crimeType" placeholder="e.g. theft, assault, vandalism" className="lowercase w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" />
                    </div>

                    <div className="flex flex-col">
                        <label htmlFor="incidentDate" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Date of Incident</label>
                        <input type="date" id="incidentDate" name="incidentDate" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" />
                    </div>

                    <div>
                        <label htmlFor="county" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">County Crime was Committed</label>
                        <input type="text" id="county" name="county" placeholder="e.g. dublin, cork, limerick, antrim" className="lowercase w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" />
                    </div>

                    <div>
                        <label htmlFor="locationDesc" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Description of Location</label>
                        <input type="text" id="locationDesc" name="locationDesc" placeholder="e.g. house no, first gate, opposite train station" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" />
                    </div>
